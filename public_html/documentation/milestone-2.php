	...
	<body>
		...
		<div class="content">
			...
			<ul>
				...
				<li>Homepage</li>
				<ul>
					<li>Landing page consisting of only a large nav bar. Nav bar contains social media buttons as well as links to content.
					</li>
					</ul>
				...
				<li>About</li>
				<ul>
					<li>Artist statement and/or bio details</li>
				</ul>

					<li>Gallery</li>
					<ul>
						<li>A gallery of Kelly’s recent/popular work</li>
					</ul>

					<li>Contact</li>
					<ul>
						<li>Information for getting in touch with kelly regarding showings, original work, and commissions</li>
					</ul>
		...
		<div class="content">
			...
			<p>The about page will consist of artist statement, headshot, and a list of events Kelly has participated in. </p>
